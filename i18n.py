...
# block below so we don't have to hand-edit all 8 dicts. Any language missing
...
_EB3: dict[str, dict[str, object]] = {
  ...
  "fr": {"btn_quiz_eb3": "EB-3 (Skilled / Professional)", "quiz_intro_eb3": "*EB-3* — visa d'immigrant fondé sur l'emploi (Skilled Workers / Professionals / Other Workers). Nécessite une offre d'emploi permanente d'un employeur américain et une certification du travail PERM ; l'employeur dépose la pétition.\n\nComme pour E-2, *toutes les conditions sont obligatoires*.\n\nRépondez « Oui » ou « Non ».", "eb3_questions": ["💼 Avez-vous une offre d'emploi permanente à temps plein (full-time) d'un employeur américain — ou un employeur est-il prêt à vous en proposer une ?", "📝 L'employeur est-il prêt à obtenir une certification du travail PERM et à déposer une pétition I-140 pour vous (EB-3 est impossible sans employeur sponsor) ?", "🎓 Répondez-vous aux exigences du poste : un diplôme de licence (Professionals), ou ≥2 ans d'expérience/de formation (Skilled), ou un poste exigeant <2 ans de préparation (Other Workers) ?", "💵 L'employeur est-il prêt à payer au moins le prevailing wage (le salaire moyen officiel pour ce poste et cette région) ?", "🔍 N'y a-t-il aucun travailleur américain qualifié disponible pour ce poste (cela est vérifié au cours du PERM) ?"]},
  "pt": {"btn_quiz_eb3": "EB-3 (Skilled / Professional)", "quiz_intro_eb3": "*EB-3* — visto de imigrante baseado em emprego (Skilled Workers / Professionals / Other Workers). Exige uma oferta de emprego permanente de um empregador dos EUA e uma certificação de trabalho PERM; o empregador apresenta a petição.\n\nAssim como o E-2, *todos os requisitos são obrigatórios*.\n\nResponda «Sim» ou «Não».", "eb3_questions": ["💼 Você tem uma oferta de emprego permanente em tempo integral (full-time) de um empregador nos EUA — ou um empregador está disposto a oferecê-la?", "📝 O empregador está disposto a obter uma certificação de trabalho PERM e apresentar uma petição I-140 por você (EB-3 é impossível sem um empregador patrocinador)?", "🎓 Você atende aos requisitos do cargo: um diploma de bacharel (Professionals), ou ≥2 anos de experiência/treinamento (Skilled), ou um cargo que exige <2 anos de preparação (Other Workers)?", "💵 O empregador está disposto a pagar pelo menos o prevailing wage (o salário médio oficial para este cargo e região)?", "🔍 Não há trabalhadores americanos qualificados disponíveis para este cargo (isso é verificado durante o PERM)?"]},
  "ht": {"btn_quiz_eb3": "EB-3 (Skilled / Professional)", "quiz_intro_eb3": "*EB-3* — viza imigran ki baze sou travay (Skilled Workers / Professionals / Other Workers). Li mande yon òf travay pèmanan nan men yon anplwayè ameriken ak yon sètifikasyon travay PERM; se anplwayè a ki depoze petisyon an.\n\nMenm jan ak E-2, *tout kondisyon yo obligatwa*.\n\nReponn «Wi» oswa «Non».", "eb3_questions": ["💼 Èske ou gen yon òf travay pèmanan a plen tan (full-time) nan men yon anplwayè ameriken — oswa èske gen yon anplwayè ki pare pou bay ou youn?", "📝 Èske anplwayè a pare pou jwenn yon sètifikasyon travay PERM epi depoze yon petisyon I-140 pou ou (EB-3 enposib san yon anplwayè ki patwone ou)?", "🎓 Èske ou ranpli kondisyon pòs la: yon diplòm bakaloreya (Professionals), oswa ≥2 ane eksperyans/fòmasyon (Skilled), oswa yon pòs ki mande <2 ane preparasyon (Other Workers)?", "💵 Èske anplwayè a pare pou peye omwen prevailing wage (salè mwayèn ofisyèl pou pòs sa a ak rejyon an)?", "🔍 Èske pa gen okenn travayè ameriken kalifye ki disponib pou pòs sa a (sa a verifye pandan PERM)?"]},
  "hi": {"btn_quiz_eb3": "EB-3 (Skilled / Professional)", "quiz_intro_eb3": "*EB-3* — रोजगार-आधारित आप्रवासी वीज़ा (Skilled Workers / Professionals / Other Workers)। इसके लिए किसी अमेरिकी नियोक्ता से स्थायी नौकरी का प्रस्ताव और PERM श्रम प्रमाणन आवश्यक है; याचिका नियोक्ता दाखिल करता है।\n\nE-2 की तरह, *सभी आवश्यकताएँ अनिवार्य हैं*।\n\n«हाँ» या «नहीं» में उत्तर दें।", "eb3_questions": ["💼 क्या आपके पास किसी अमेरिकी नियोक्ता से स्थायी पूर्णकालिक (full-time) नौकरी का प्रस्ताव है — या कोई नियोक्ता इसे देने के लिए तैयार है?", "📝 क्या नियोक्ता PERM श्रम प्रमाणन प्राप्त करने और आपके लिए I-140 याचिका दाखिल करने को तैयार है (किसी प्रायोजक नियोक्ता के बिना EB-3 असंभव है)?", "🎓 क्या आप पद की आवश्यकताओं को पूरा करते हैं: स्नातक की डिग्री (Professionals), या ≥2 वर्ष का अनुभव/प्रशिक्षण (Skilled), या ऐसा पद जिसके लिए <2 वर्ष की तैयारी चाहिए (Other Workers)?", "💵 क्या नियोक्ता कम से कम prevailing wage (इस पद और क्षेत्र के लिए आधिकारिक औसत वेतन) देने को तैयार है?", "🔍 क्या इस पद के लिए कोई योग्य अमेरिकी कर्मचारी उपलब्ध नहीं है (यह PERM के दौरान जाँचा जाता है)?"]},
}
